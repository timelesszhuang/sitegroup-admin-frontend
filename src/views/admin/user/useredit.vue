            ...
            <div>
                <Form ref="useredit" :model="form" :label-width="90" :rules="userEditRule" class="user-edit-form">
                    <Form-item label="登录名" prop="user_name">
                        <Input type="text" disabled v-model="form.user_name" placeholder="请输入登陆名"/>
                    </Form-item>
                    <Form-item label="新密码" prop="pwd">
                        <Input type="password" v-model="form.pwd" placeholder="请输入新密码"/>
                    </Form-item>
                    <Form-item label="重复新密码" prop="pwd2">
                        <Input type="password" v-model="form.pwd2" placeholder="请再次输入新密码"/>
                    </Form-item>
                    <Form-item label="公司" prop="name">
                        <Input type="text" v-model="form.name" placeholder="请输入公司名"/>
                    </Form-item>
                    <Form-item label="联系人" prop="contacts">
                        <Input type="text" v-model="form.contacts" placeholder="请输入联系人"/>
                    </Form-item>
                    <Form-item label="手机号" prop="mobile">
                        <Input type="text" v-model="form.mobile" placeholder="请输入手机号"/>
                    </Form-item>
                    <Form-item label="固话" prop="tel">
                        <Input type="text" v-model="form.tel" placeholder="请输入固话"/>
                    </Form-item>
                    <Form-item label="邮箱" prop="email">
                        <Input type="text" v-model="form.email" placeholder="请输入邮箱地址"/>
                    </Form-item>
                    <Form-item label="微信" prop="wechat">
                        <Input type="text" v-model="form.wechat" placeholder="请输入微信账号"/>
                    </Form-item>
                    <Form-item label="易企秀帐号" prop="yqx_account">
                        <Input type="text" v-model="form.yqx_account" placeholder="请输入易企秀账号"/>
                    </Form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            init(edit_id) {
                this.apiGet('user/' + edit_id).then((res) => {
