<template>
    <div>
        ...
        <!--用户添加操作-->
        <Useradd ref="add" :industry="industry" v-on:getdata="getData"></Useradd>
        <Useredit ref="edit" :form="editinfo" :industry="industry" v-on:getdata="getData"></Useredit>
        <Usershow ref="show" :form="editinfo" v-on:getdata="getData"></Usershow>
