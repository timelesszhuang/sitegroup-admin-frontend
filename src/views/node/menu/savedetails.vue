<template>
    <div>
        <Modal
                v-model="modal" width="900" :styles="{top: '20px'}" :mask-closable="false">
            <p slot="header">
                <span>修改详情型栏目</span>
            </p>
            <div>
                <Form ref="detailadd" :model="detail" :label-width="90" :rules="AddRule" class="node-add-form">
                    <Form-item label="栏目/菜单名称" prop="name">
                        <Input type="text"
                               v-model="detail.name" placeholder="请填写栏目/菜单名字"/>
                    </Form-item>
                    ...
                    <Form-item label="上级分类" prop="p_id">
                        <Select v-model="detail.p_id"
                                style="text-align: left;width:200px;position: relative;z-index: 10001"
