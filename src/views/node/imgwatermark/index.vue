<template>
    <div>
        ...
        <imgadd ref="add" v-on:getdata="getData"></imgadd>
        <imgsave ref="save" :form="editinfo" v-on:getdata="getData"></imgsave>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.apiGet('siteWaterImage', data).then((data) => {
            ...
            edit(index) {
                ...
                this.apiGet('siteWaterImage/' + editid).then((res) => {
