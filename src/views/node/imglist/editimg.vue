<template>
    <div>
        <div>
            <Modal v-model="modal" width="900" :styles="{top: '20px'}">
                <p slot="header">
                    <span>轮播图集管理</span>
                </p>
                <div>
                    <div v-if="is_show" style="padding: 10px">
                        <Carousel v-model="value1" autoplay>
                            <CarouselItem v-for="(item,index) in form.imglist" :key="index">
                                <div class="eventmouse"
                                     style="display:flex;height:auto;min-height: 300px; max-height:350px;max-width:100%;">
                    ...
                    <Tabs value="name1">
                        <TabPane label="添加图片" name="name1">
                            <Form ref="addimage" :model="addform" :label-width="120" :rules="AddRule1"
                                  class="node-add-form">
