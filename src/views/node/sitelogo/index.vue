<template>
    <div>
        ...
        <logoadd ref="add" v-on:getdata="getData"></logoadd>
        <logosave ref="save" :form="editinfo" v-on:getdata="getData"></logosave>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.apiGet('siteLogo', data).then((data) => {
            ...
            edit(index) {
                ...
                this.apiGet('siteLogo/' + editid).then((res) => {
