                    ...
                    <Form ref="customesave" :model="form" :label-width="90" :rules="AddRule" class="node-add-form">
                        ...
                        <Row>
                            ...
                            <Form-item label="type类型" style="width: 250px;" prop="type1">
                                <Select v-model="field1.type" clearable style="width:150px">
                                    <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label
                                        }}
                                    </Option>
                                </Select>
                            </Form-item>
                        ...
                        <div v-show="info.field3">
                            <Row>
                                ...
                                <Form-item label="分类名称3" style="width: 240px;" prop="name2">
                                    <Input type="text" v-if="info.field3" v-model="field3.name"
                                           placeholder="请输入名称"></Input>
                                </Form-item>
                                </Col>
                                <Col span="6">
                                <Form-item label="placeholder3" style="width: 250px;" prop="placeholder2">
                                    <Input type="text" v-if="info.field3" v-model="field3.placeholder"
                                           placeholder="请输入placeholder配置"></Input>
                                </Form-item>
                                </Col>
                                <Col span="6">
                        ...
                        <div v-show="info.field4">
                            <Row>
                                <Col span="6">
                                <Form-item label="分类名称4" style="width: 240px;" prop="name2">
                                    <Input type="text" v-if="info.field4" v-model="info.field4.name"
                                           placeholder="请输入名称"></Input>
                                </Form-item>
                                </Col>
                                <Col span="6">
                                <Form-item label="placeholder4" style="width: 250px;" prop="placeholder2">
                                    <Input type="text" v-if="info.field4" v-model="field4.placeholder"
                                           placeholder="请输入placeholder配置"></Input>
                                </Form-item>
                                </Col>
                                <Col span="6">
...
//        return
                this.$refs.customesave.validate((valid) => {
                    if (valid) {
                        ...
                        let data = this.form;
                        let id = data.id;
                        this.apiPut('userDefinedform/' + id, data).then((res) => {
