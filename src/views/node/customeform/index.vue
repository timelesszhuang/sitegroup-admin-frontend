<template>
    <div>
        ...
        <customefromadd ref="add" v-on:getdata="getData"></customefromadd>
        <customefromcode ref="code" :form="getinfo" v-on:getdata="getData"></customefromcode>
        <customefromsave ref="save" :info="info" :form="editinfo" :field1="field1" :field2="field2" :field3="field3"
                         :field4="field4" v-on:getdata="getData"></customefromsave>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.apiGet('userDefinedform', data).then((data) => {
            ...
            edit(index) {
                ...
                this.apiGet('userDefinedform/' + editid).then((res) => {
            ...
            getcode(index) {
                ...
                this.apiGet('userDefinedformcode/' + getid).then((res) => {
                    this.handleAjaxResponse(res, (data, msg) => {
                        this.getinfo = data
                        this.modal = false;
