...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        components: {padd, editimg, psave, urladd, urlsave},
        created() {
            this.getData();
        },
        methods: {
            getData() {
                ...
                this.apiGet('activityabout', data).then((data) => {
            ...
            edit(params) {
                ...
                this.apiGet('activityabout/' + editid).then((res) => {
            ...
            start(params) {
                ...
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        _this.apiGet('changeactivityStatus/' + editid + "/10").then((res) => {
            ...
            stop(params) {
                ...
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        _this.apiGet('changeactivityStatus/' + editid + "/20").then((res) => {
                            _this.handleAjaxResponse(res, (data, msg) => {
                                _this.getData();
                                _this.$Message.success(msg);
                            }, (data, msg) => {
