<template>
  <div>
    ...
    <staticconfigadd :site="site" ref="add" v-on:getdata="getData"></staticconfigadd>
    <staticconfigsave ref="save" :site="site" :form="editinfo" v-on:getdata="getData"></staticconfigsave>
  </div>
</template>
