    ...
    <card>
        <div>
            ...
            <div>
                <br>
                <Alert type="success">
                    文章中某些 <span style="font-weight: bold">关键词</span> 替换为 您需要的 词语。
                </Alert>
            </div>
    ...
    export default {
        ...
        methods: {
            getData() {
                ...
                this.apiGet('Substitution', data).then((data) => {
            ...
            edit(index) {
                ...
                this.apiGet('Substitution/' + editid).then((res) => {
            ...
            remove(index) {
                ...
                this.$Modal.confirm({
                    ...
                    cancelText: '取消',
                    onOk: (index) => {
                        _this.apiDelete('Substitution/', id).then((res) => {
