                        ...
                        <Row v-if="is_show">
                            ...
                            <Form-item label="修改产品图片" prop="imgser">
                                <Select style="width:120px;" placeholder="产品图片" label-in-value filterable
                                    ...
                                    <Option v-for="(item,index) in form.imglist" :value="index" :key="index">图片{{index +
                                        1}}
                                    </Option>
                                </Select>
                            </Form-item>
  ...
  export default {
      data () {
          return {
              ...
              // 是不是需要显示修改等操作
              is_show: false,
              action: HOST + 'upload_product_ser_img'
          };
      },
      created () {
      },
      ...
      methods: {
          editimg (editid) {
              this.apiGet('get_product_img_list/' + editid).then((res) => {
          ...
          delimg () {
              ...
              this.$Modal.confirm({
                  ...
                  cancelText: '取消',
                  onOk: (index) => {
                      _this.apiGet('delete_product_img/' + id + '/' + _this.imgIndex).then((res) => {
