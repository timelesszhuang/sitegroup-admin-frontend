                ...
                <Row class="pad">
                    <div v-for="(item,index) in datas">
                        <div @click="show(index)">
                            ...
                            <div style="width:100%;">
                                <img class="imgsize" style="margin:0 auto;padding-right:5px;display: block " :src=formatter_str(item.img) target="_blank"></div>
                            <div style="text-align:center;font-size:15px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;cursor:pointer "
                                 :title=item.title>
                                {{item.title}}
                            </div>
                            <div style="text-align:center;font-size:15px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;cursor:pointer;height: auto ">
                                ...
                                <div>
                                    <span style="color:red;font-size: 10px"
                                          :title=item.industry_name><i>行业分类:</i></span>
                                    {{item.industry_name}}&nbsp;
    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                ...
                this.apiGet('marketing_mode', data).then((data) => {
